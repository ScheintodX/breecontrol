...
BAG.Kiln = (function($,Ψ){
	...
	return function( elem, device, passive ) {
		...
		var Kiln = {
			...
			setHeaterPowerStatus: ψ.asDegree( ψ.text( 'heater_power_status' ) ),
			setHeaterPowerNominal: ψ.asDegree( ψ.text( 'heater_power_nominal' ) ),
			setHeaterPowerIcon: ψ.asPowerColor( ψ.fill( 'temp_heater_icon' ) ),
